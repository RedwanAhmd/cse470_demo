<?php require_once '../controller/db_con.php';?>
<!doctype html>
<html lang="en">
  <head>
  ...
  <body>
    <div class="container"><br>
      <a class="btn btn-primary float-right" href="../controller/login.php">Login</a>
          <h1 class="text-center">Welcome to Student Registration System!</h1><br>
